import { Context, Koa } from "../../node-to-deno/koa.ts";

import { ContextDelegatedRequest, IRequest } from "./IRequest.ts";
import { ContextDelegatedResponse, IResponse } from "./IResponse.ts";
